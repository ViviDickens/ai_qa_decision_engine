...
class InsecureOutputValidator(BaseDetector):
    """
    Detects LLM02: Insecure Output Handling.
    ...
    def __init__(self):
        super().__init__()
        self.threat_id = OWASPThreat.LLM02_INSECURE_OUTPUT
        self.threat_name = "Insecure Output"
